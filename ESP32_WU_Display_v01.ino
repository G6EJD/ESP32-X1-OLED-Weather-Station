...
void setup() { 
 ...
 display.setContrast(255);
  ...
  display.drawString(10,25,"Starting...");
  display.display();
...
void loop() {
 ...
 if(CurrCondObj(&currCondString)) {
   ...
   if (icon == "snow" ||
       ...
       icon == "nt_chancesnow" || 
       icon == "nt_flurries" ||
       icon == "nt_snow") display.drawXbm(0,20, icon_width, icon_height, snow_icon);
   if (icon == "rain" || 
       icon == "chancerain" ||
       icon == "nt_chancerain" ||
       icon == "nt_rain") display.drawXbm(0,20, icon_width, icon_height, rain_icon);
   if (icon == "sleet" || 
       icon == "chancesleet" ||
       icon == "nt_chancesleet" ||
       icon == "nt_sleet") display.drawXbm(0,20, icon_width, icon_height, sleet_icon);
   if (icon == "sunny" ||
       icon == "clear") display.drawXbm(0,20, icon_width, icon_height, sunny_icon);
   if (icon == "cloudy" ||
       icon == "nt_cloudy") display.drawXbm(0,20, icon_width, icon_height, cloudy_icon);
   if (icon == "mostlysunny" ||
       icon == "partlycloudy" ||
       icon == "partlysunny" ||
       icon == "mostlycloudy") display.drawXbm(0,20, icon_width, icon_height, mostlysunny_icon);
   if (icon == "fog" ||
       icon == "nt_fog" ||
       icon == "nt_hazy" ||
       icon == "hazy") display.drawXbm(0,20, icon_width, icon_height, fog_icon);
   if (icon == "tstorms" ||
       icon == "chancetstorms" ||
       icon == "nt_tstorms" ||
       icon == "nt_chancetstorms") display.drawXbm(0,20, icon_width, icon_height, tstorms_icon);
   if (icon == "nt_mostlycloudy" ||
       icon == "nt_mostlysunny" ||
       icon == "nt_partlycloudy" ||
       icon == "nt_partlysunny") display.drawXbm(0,20, icon_width, icon_height, nt_mostlycloudy_icon);
   if (icon == "nt_clear") display.drawXbm(0,20, icon_width, icon_height, nt_clear_icon);
   display.setTextAlignment(TEXT_ALIGN_LEFT);
   display.drawString(3, 0 ,"WX: "+getLocalTime().substring(0,12)+getLocalTime().substring(14,22)); 
   display.drawString(50,15,getCurrWeather());
   display.drawString(50,27,getCurrC()+"°C / "+getRelHum()); // use getCurrF for fahrenheit
   display.drawString(50,39,getWindDir()+" @ "+getWindMPH()+"mph");
   display.drawString(50,51,getPressure_mb()+"mB ["+getPressure_trend()+"]");
   display.display();
  }
  delay(15*60000); //WU restricts API calls in any 24-hours, ~ 100 is a suggested maximum
}
